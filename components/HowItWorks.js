...
const steps = [
  {
    ...
    glow: "group-hover:bg-red-600/8",
    iconRing: "bg-red-500/15 border-red-500/25",
    iconColor: "text-red-400",
    numColor: "text-red-400/10",
  },
  {
    ...
    glow: "group-hover:bg-blue-600/8",
    iconRing: "bg-blue-500/15 border-blue-500/25",
  ...
  },
  {
    ...
    badge: "99.9% uptime",
    glow: "group-hover:bg-emerald-600/8",
    iconRing: "bg-emerald-500/15 border-emerald-500/25",
  ...
  },
  {
    ...
    badge: "10× capacity",
    glow: "group-hover:bg-violet-600/8",
    iconRing: "bg-violet-500/15 border-violet-500/25",
    iconColor: "text-violet-400",
    numColor: "text-violet-400/10",
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div ref={headerRef} className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <motion.h2
            ...
            style={SERIF}
            className="text-4xl md:text-[52px] font-black text-white leading-tight tracking-tight mb-5"
          >
          ...
          {steps.map((s, i) => (
            <div key={s.num} className="flex items-center gap-2">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
                <span className="w-5 h-5 rounded-full bg-red-600/30 border border-red-500/40 text-[10px] font-black text-red-400 flex items-center justify-center">{s.num}</span>
                <span className="text-[12px] text-white/45 font-semibold">{s.label}</span>
              </div>
              {i < steps.length - 1 && (
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-14">
          {steps.map((step, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`relative glass-dark rounded-3xl p-8 overflow-hidden border border-white/8 hover:border-white/15 transition-all group cursor-default`}
            >
              {/* Hover glow overlay */}
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-white/35">{step.label}</span>
                  </div>
                </div>
                ...
                <ul className="space-y-2.5 mb-6">
                  {step.features.map(f => (
                    <li key={f} className="flex items-center gap-2.5 text-[13px] text-white/70 font-medium">
                ...
                {/* Bottom badge */}
                <div className="flex items-center gap-2 pt-5 border-t border-white/8">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse shrink-0" />
                  <span className="text-[12px] text-white/40 font-semibold">{step.badge}</span>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          ...
          <p className="text-[13px] text-white/35 mt-3">Free consultation · No commitment</p>
        </motion.div>
